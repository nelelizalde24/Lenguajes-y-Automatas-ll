...
public class compiladorLexer extends Lexer {
	...
	public final void mINT() throws RecognitionException {
		try {
			int _type = INT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// compilador.g:44:16: ( 'int' )
			// compilador.g:44:18: 'int'
			{
			match("int"); 
	...
	public final void mDOUBLE() throws RecognitionException {
		try {
			int _type = DOUBLE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// compilador.g:45:16: ( 'double' )
			// compilador.g:45:18: 'double'
			{
			match("double"); 
	...
	public final void mSTRING() throws RecognitionException {
		try {
			int _type = STRING;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// compilador.g:46:16: ( 'String' )
			// compilador.g:46:18: 'String'
			{
			match("String"); 
	...
	public final void mPUBLIC() throws RecognitionException {
		try {
			int _type = PUBLIC;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// compilador.g:47:16: ( 'public' )
			// compilador.g:47:18: 'public'
			{
			match("public"); 
	...
	public final void mPRIVATE() throws RecognitionException {
		try {
			int _type = PRIVATE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// compilador.g:48:16: ( 'private ' )
			// compilador.g:48:18: 'private '
			{
			match("private "); 
	...
	public final void mPROTECTED() throws RecognitionException {
		try {
			int _type = PROTECTED;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// compilador.g:49:16: ( 'protected ' )
			// compilador.g:49:18: 'protected '
			{
			match("protected "); 
	...
	public final void mCLASS() throws RecognitionException {
		try {
			int _type = CLASS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// compilador.g:52:16: ( 'class' )
			// compilador.g:52:18: 'class'
			{
			match("class"); 
	...
	public final void mCINT() throws RecognitionException {
		try {
			int _type = CINT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// compilador.g:57:16: ( ( '0' .. '9' )+ )
			// compilador.g:57:18: ( '0' .. '9' )+
			{
			// compilador.g:57:18: ( '0' .. '9' )+
			int cnt1=0;
			loop1:
	...
	public final void mCFLOAT() throws RecognitionException {
		try {
			int _type = CFLOAT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// compilador.g:58:16: ( CINT DOT CINT )
			// compilador.g:58:18: CINT DOT CINT
			{
			mCINT(); 
	...
	public final void mID() throws RecognitionException {
		try {
			int _type = ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// compilador.g:59:16: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
			// compilador.g:59:18: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			{
			...
			// compilador.g:59:41: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			loop2:
			while (true) {
				int alt2=2;
